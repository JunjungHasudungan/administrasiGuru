    ...
    <div class="flex flex-col justify-between sm:flex-row">
      <div class="flex items-end justify-left ml-10 mt-5">
          <div
              ...
              <a href="#"
                  class="hover:text-primary-600 text-indigo-400 hover:font-bold ">Role</a>
              <svg class="w-3 h-3"
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 20 20"
                  fill="currentColor">
      ...
      <div class="bg-white p-5  shadow-sm">
          <div class="grid grid-cols-8 gap-4 mb-4">
            <div class="col-span-1 mt-2 h-full p-1">
                <button wire:click="create()" class="inline-flex items-center justify-center px-10 py-2 text-sm font-bold tracking-wide text-white transition bg-blue-500 border border-transparent rounded shadow select-none focus:border-blue-600 hover:bg-blue-600 focus:outline-none focus:ring focus:ring-blue-500 focus:ring-opacity-30 disabled:opacity-50">Tambah Anggota</button>
                @if($isModal)
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <a href="{{ route('admin.roles.show', $role->id) }}"
                                          ...
                                          <form action="{{ route('admin.roles.destroy', $role->id) }}" class="inline" method="post" onsubmit="return confirm('Yakin untuk menghapus {{$role->name}}?'); ">
                                            @csrf
                                            @method('delete')
                                            <button type="submit"
