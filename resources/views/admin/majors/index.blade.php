                  ...
                  <tr class="bg-white border-2 border-gray-200">
                      ...
                      <td class="px-6 text-right select-none whitespace-nowrap">
                        <a href="{{ route('admin.majors.show', $major->id) }}"
                          class="inline-flex items-center justify-center px-4 py-2 text-sm font-medium tracking-wide text-white bg-stone-700 transition border border-transparent rounded-full shadow select-none bg-lightBlue-500 focus:border-lightBlue-600 hover:bg-lightBlue-600 focus:outline-none focus:ring focus:ring-lightBlue-500 focus:ring-opacity-30 disabled:opacity-50">
